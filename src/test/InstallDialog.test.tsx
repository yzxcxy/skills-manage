...
describe("InstallDialog", () => {
  ...
  it("shows detected non-central agent checkboxes", () => {
    renderDialog();
  ...
  it("does not show 'not detected' badge because undetected agents are hidden", () => {
    renderDialog();
  ...
  it("opens with no installable platforms selected", () => {
    renderDialog();
